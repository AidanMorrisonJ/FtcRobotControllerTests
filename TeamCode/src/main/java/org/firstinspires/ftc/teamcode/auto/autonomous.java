...
public class autonomous extends LinearOpMode {
	...
	moveRobot_forward(DRIVE_SPEED,0,8);
	//	            encoderDrive(DRIVE_SPEED, 12, 12, 5.0);
            while (!gamepad1.a) {
                sleep(1);
            }
	moveRobot_backward(DRIVE_SPEED,0,8);
            while (!gamepad1.a) {
                sleep(1);
            }
           ...
           // sleep(100);
            // left_turn(35);
            // telemetry.addData("> l25", "angle: %.1f", gyro.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES).firstAngle);
            // telemetry.update();
            // while (!gamepad1.a) {
            //     sleep(1);
            // }
